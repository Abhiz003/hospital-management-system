...
import com.hospital.hms.model.generator.StringPrefixedSequenceIdGenerator;
...
public class User implements Serializable {
    ...
    @GenericGenerator(
            name = "user_seq",
            strategy = "com.hospital.hms.model.generator.StringPrefixedSequenceIdGenerator",
            parameters = {
...
/*
    ...
    @Column(name="is_active", columnDefinition = "NUMBER(1) DEFAULT 0 NOT NULL")
    private boolean isActive;

    @NotNull(message = "isResetPassword cannot be null")
    @JsonProperty("isResetPassword")
    @Column(name="is_reset_password", columnDefinition = "NUMBER(1) DEFAULT 0 NOT NULL")
